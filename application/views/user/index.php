      ...
      <div class="container">
        ...
        <div class="row about-cols">
          ...
          <div class="col-md-4 wow fadeInUp">
            <div class="about-col">
              <div class="img">
                <img src="<?php echo base_url()?>assets/user/img/about-mission.jpg" alt="" class="img-fluid">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.1s">
            <div class="about-col">
              <div class="img">
                <img src="<?php echo base_url()?>assets/user/img/about-plan.jpg" alt="" class="img-fluid">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              <div class="img">
                <img src="<?php echo base_url()?>assets/user/img/about-vision.jpg" alt="" class="img-fluid">
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
            <div class="portfolio-wrap">
              <figure>
                <img src="<?php echo base_url()?>assets/user/img/portfolio/app1.jpg" class="img-fluid" alt="">
                <a href="<?php echo base_url()?>assets/user/img/portfolio/app1.jpg" data-lightbox="portfolio" data-title="App 1" class="link-preview" title="Preview"><i class="ion ion-eye"></i></a>
    ...
    <section id="clients" class="wow fadeInUp">
      <div class="container">
        ...
        <div class="owl-carousel clients-carousel">
          <img src="<?php echo base_url()?>assets/user/img/clients/client-1.png" alt="">
          <img src="<?php echo base_url()?>assets/user/img/clients/client-2.png" alt="">
          <img src="<?php echo base_url()?>assets/user/img/clients/client-3.png" alt="">
          <img src="<?php echo base_url()?>assets/user/img/clients/client-4.png" alt="">
          <img src="<?php echo base_url()?>assets/user/img/clients/client-5.png" alt="">
          <img src="<?php echo base_url()?>assets/user/img/clients/client-6.png" alt="">
          <img src="<?php echo base_url()?>assets/user/img/clients/client-7.png" alt="">
          <img src="<?php echo base_url()?>assets/user/img/clients/client-8.png" alt="">
        </div>
      ...
      <div class="container">
        ...
        <div class="owl-carousel testimonials-carousel">
          ...
          <div class="testimonial-item">
            <img src="<?php echo base_url()?>assets/user/img/testimonial-1.jpg" class="testimonial-img" alt="">
            <h3>Saul Goodman</h3>
            <h4>Ceo &amp; Founder</h4>
            <p>
              <img src="<?php echo base_url()?>assets/user/img/quote-sign-left.png" class="quote-sign-left" alt="">
          ...
          <div class="testimonial-item">
            <img src="<?php echo base_url()?>assets/user/img/testimonial-2.jpg" class="testimonial-img" alt="">
            <h3>Sara Wilsson</h3>
            <h4>Designer</h4>
            <p>
              <img src="<?php echo base_url()?>assets/user/img/quote-sign-left.png" class="quote-sign-left" alt="">
          ...
          <div class="testimonial-item">
            <img src="<?php echo base_url()?>assets/user/img/testimonial-3.jpg" class="testimonial-img" alt="">
            <h3>Jena Karlis</h3>
            <h4>Store Owner</h4>
            <p>
              <img src="<?php echo base_url()?>assets/user/img/quote-sign-left.png" class="quote-sign-left" alt="">
          ...
          <div class="testimonial-item">
            <img src="<?php echo base_url()?>assets/user/img/testimonial-4.jpg" class="testimonial-img" alt="">
            <h3>Matt Brandon</h3>
            <h4>Freelancer</h4>
            <p>
              <img src="<?php echo base_url()?>assets/user/img/quote-sign-left.png" class="quote-sign-left" alt="">
          ...
          <div class="testimonial-item">
            <img src="<?php echo base_url()?>assets/user/img/testimonial-5.jpg" class="testimonial-img" alt="">
            <h3>John Larson</h3>
            <h4>Entrepreneur</h4>
            <p>
